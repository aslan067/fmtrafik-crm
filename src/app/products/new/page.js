...
import { Save, X, Calculator, TrendingUp, AlertCircle } from 'lucide-react'
...
export default function NewProductPage() {
  ...
  function calculatePrices() {
    ...
    if (supplier.discount_type === 'percentage' && formData.supplier_discount_percentage) {
      // İskonto yüzdesi ile maliyet hesapla
      ourCost = parseFloat(formData.supplier_list_price) * 
                (1 - parseFloat(formData.supplier_discount_percentage) / 100)
    } else if (supplier.discount_type === 'net_price' && formData.price_multiplier) {
      // Net fiyat x çarpan = liste fiyatı
      // Tedarikçi net fiyatı = supplier_list_price (bu durumda liste fiyatı değil net fiyattır)
      ourCost = parseFloat(formData.supplier_list_price)
      dealerList = ourCost * parseFloat(formData.price_multiplier)
    }

    // İskontolu tedarikçi için de bayi listesi hesapla
    if (supplier.discount_type === 'percentage') {
      // Maliyet üzerine %20-30 kar koyarak bayi listesi oluştur
    ...
    try {
      ...
      if (formData.specifications) {
        try {
          ...
          // Eğer JSON değilse, basit text olarak kaydet
      ...
      const insertData = {
        ...
        list_price: dealerList, // Geriye dönük uyumluluk
      ...
      <div className="p-6">
        <div className="max-w-6xl mx-auto">
          <div className="mb-6">
            ...
            <p className="text-gray-600 mt-2">Ürün bilgilerini, tedarikçi ve fiyatlandırma detaylarını girin</p>
          </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        ...
                        placeholder='{"renk": "Sarı", "malzeme": "Plastik"}'
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-white rounded-lg">
                      ...
                      <p className="text-xl font-bold text-gray-900">
                        ₺{ourCost.toLocaleString('tr-TR', { minimumFractionDigits: 2 })}
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-white rounded-lg">
                      ...
                      <p className="text-xl font-bold text-blue-600">
                        ₺{dealerList.toLocaleString('tr-TR', { minimumFractionDigits: 2 })}
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-white rounded-lg border-2 border-green-300">
                      ...
                      <p className="text-2xl font-bold text-green-600">
                        ₺{dealerNet.toLocaleString('tr-TR', { minimumFractionDigits: 2 })}
                      </p>
                    </div>
                    ...
                    {profitMargin > 0 && (
                      <div className="p-3 bg-gradient-to-r from-purple-100 to-pink-100 rounded-lg">
                        ...
                        <p className="text-xs text-gray-600 mt-1">
                          ₺{(dealerNet - ourCost).toLocaleString('tr-TR', { minimumFractionDigits: 2 })} kar
                        </p>
                      </div>
                    )}
                  </div>
