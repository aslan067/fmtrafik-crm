...
export default function NewProductPageUpdated() {
  const [loading, setLoading] = useState(false)
  const [error, setError] = useState('')
  const [imagePreview, setImagePreview] = useState(null)
  const [suppliers, setSuppliers] = useState([
    { id: '1', name: 'Tedarikçi A', code: 'SUP001', discount_type: 'percentage', discount_value: 45 },
    { id: '2', name: 'Tedarikçi B', code: 'SUP002', discount_type: 'net_price', price_multiplier: 1.8 }
  ])
  const [productGroups, setProductGroups] = useState([
    { id: '1', name: 'A Grubu (Premium)', code: 'A', dealer_discount_percentage: 45 },
    { id: '2', name: 'B Grubu (Standard)', code: 'B', dealer_discount_percentage: 25 }
  ])
  ...
  const handleImageUpload = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        setFormData(prev => ({
          ...prev,
          image_url: reader.result // Gerçek projede Supabase Storage kullanılacak
        }))
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Validasyon
      if (!formData.product_code || !formData.name) {
        throw new Error('Ürün kodu ve adı zorunludur')
      }
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        min="0"
                        step="0.01"
                        className="w-full px-3 py-2 pl-8 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                        placeholder="0.00"
                      />
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          max="100"
                          step="0.01"
                          className="w-full px-3 py-2 pr-8 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                          placeholder="0.00"
                        />
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        min="0"
                        step="0.01"
                        className="w-full px-3 py-2 pl-8 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-lg font-semibold"
                        placeholder="0.00"
                      />
                    </div>
                  </div>
